import {S as dr, i as gr, s as mr, e as _, k as R, t as C, c as w, a as y, d as g, m as V, h as E, b as m, f as qn, g as Ft, J as c, j as Ae, n as rr, K as Nt, L as Ue, M as Fe, x as Kr, y as jr, z as $r, r as ti, p as ei, N as Wn, C as ni, O as yi, w as Ns, P as Me, Q as mo, R as Gn, T as vo, U as yo, V as Cs, W as Es, X as As} from "../chunks/index-99a66179.js";
function jn(t, e) {
...
function wa(t, e, n) {
    var r = (e - t) / Math.max(0, n)
      ...
      , o = r / Math.pow(10, i);
    return i >= 0 ? (o >= ri ? 10 : o >= ii ? 5 : o >= oi ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (o >= ri ? 10 : o >= ii ? 5 : o >= oi ? 2 : 1)
}
function si(t, e, n) {
    var r = Math.abs(e - t) / Math.max(0, n)
      , i = Math.pow(10, Math.floor(Math.log(r) / Math.LN10))
      , o = r / i;
    return o >= ri ? i *= 10 : o >= ii ? i *= 5 : o >= oi && (i *= 2),
    e < t ? -i : i
}
function It(t, e) {
    let n;
...
function ba(t, e) {
    ...
    function p(d) {
        ...
        Y = Y.merge(Q),
        Z = Z.merge(Q.append("line").attr("stroke", "currentColor").attr(f + "2", l * o)),
        D = D.merge(Q.append("text").attr("fill", "currentColor").attr(f, l * F).attr("dy", t === Hr ? "0em" : t === li ? "0.71em" : "0.32em")),
        d !== H && (M = M.transition(d),
        Y = Y.transition(d),
        Z = Z.transition(d),
        D = D.transition(d),
        nt = nt.transition(d).attr("opacity", bo).attr("transform", function(J) {
            return isFinite(J = W(J)) ? h(J + u) : this.getAttribute("transform")
        }),
        ...
        nt.remove(),
        M.attr("d", t === Dn || t === Rr ? a ? "M" + l * a + "," + B + "H" + u + "V" + O + "H" + l * a : "M" + u + "," + B + "V" + O : a ? "M" + B + "," + l * a + "V" + u + "H" + O + "V" + l * a : "M" + B + "," + u + "H" + O),
        Y.attr("opacity", 1).attr("transform", function(J) {
            return h(W(J) + u)
        }),
        Z.attr(f + "2", l * o),
        D.attr(f, l * F).text(S),
        H.filter(Xs).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Rr ? "start" : t === Dn ? "end" : "middle"),
        H.each(function() {
            this.__axis = W
        })
    }
...
$n.prototype = xa.prototype = {
    constructor: $n,
    on: function(t, e) {
        var n = this._, r = Ks(t + "", n), i, o = -1, a = r.length;
        if (arguments.length < 2) {
            for (; ++o < a; )
                if ((i = (t = r[o]).type) && (i = js(n[i], t.name)))
                    return i;
            return
        }
...
function $s(t) {
    return function() {
        var e = this.ownerDocument
          , n = this.namespaceURI;
        return n === ui && e.documentElement.namespaceURI === ui ? e.createElement(t) : e.createElementNS(n, t)
    }
}
function tl(t) {
    return function() {
...
function nl(t) {
    ...
    for (var e = this._groups, n = e.length, r = new Array(n), i = 0; i < n; ++i)
        for (var o = e[i], a = o.length, s = r[i] = new Array(a), u, l, f = 0; f < a; ++f)
            (u = o[f]) && (l = t.call(u, u.__data__, f, o)) && ("__data__"in u && (l.__data__ = u.__data__),
            s[f] = l);
...
function al(t) {
    ...
    for (var e = this._groups, n = e.length, r = [], i = [], o = 0; o < n; ++o)
        for (var a = e[o], s = a.length, u, l = 0; l < s; ++l)
            (u = a[l]) && (r.push(t.call(u, u.__data__, l, a)),
            i.push(u));
    return new Jt(r,i)
}
function Ta(t) {
...
function dl(t) {
    return this.selectAll(t == null ? hl : pl(typeof t == "function" ? t : Da(t)))
}
function gl(t) {
...
function yl(t, e, n, r, i, o) {
    for (var a = 0, s, u = e.length, l = o.length; a < l; ++a)
        ...
        r[a] = s) : n[a] = new ir(t,o[a]);
    for (; a < u; ++a)
        (s = e[a]) && (i[a] = s)
}
function _l(t, e, n, r, i, o, a) {
    var s, u, l = new Map, f = e.length, h = o.length, p = new Array(f), d;
    for (s = 0; s < f; ++s)
        (u = e[s]) && (p[s] = d = a.call(u, u.__data__, s, e) + "",
        l.has(d) ? i[s] = u : l.set(d, u));
    for (s = 0; s < h; ++s)
        d = a.call(t, o[s], s, o) + "",
        (u = l.get(d)) ? (r[s] = u,
        u.__data__ = o[s],
        l.delete(d)) : n[s] = new ir(t,o[s]);
    for (s = 0; s < f; ++s)
...
function Tl(t) {
    for (var e = t.selection ? t.selection() : t, n = this._groups, r = e._groups, i = n.length, o = r.length, a = Math.min(i, o), s = new Array(i), u = 0; u < a; ++u)
        for (var l = n[u], f = r[u], h = l.length, p = s[u] = new Array(h), d, k = 0; k < h; ++k)
            (d = l[k] || f[k]) && (p[k] = d);
    for (; u < i; ++u)
        s[u] = n[u];
...
function Yl(t, e) {
    ...
    return this.each((e == null ? n.local ? Il : zl : typeof e == "function" ? n.local ? Vl : Rl : n.local ? Hl : Ll)(n, e))
}
function Pa(t) {
...
function Gl(t, e, n) {
    return arguments.length > 1 ? this.each((e == null ? Ol : typeof e == "function" ? Wl : ql)(t, e, n == null ? "" : n)) : hn(this.node(), t)
}
function hn(t, e) {
...
function Ql(t, e) {
    return arguments.length > 1 ? this.each((e == null ? Bl : typeof e == "function" ? Zl : Xl)(t, e)) : this.node()[t]
}
function Na(t) {
...
function Ca(t) {
    this._node = t,
    this._names = Na(t.getAttribute("class") || "")
}
Ca.prototype = {
    add: function(t) {
...
function ru(t) {
    return arguments.length ? this.each(t == null ? tu : (typeof t == "function" ? nu : eu)(t)) : this.node().textContent
}
function iu() {
    this.innerHTML = ""
}
...
function su(t) {
    return arguments.length ? this.each(t == null ? iu : (typeof t == "function" ? au : ou)(t)) : this.node().innerHTML
}
function lu() {
...
function xe(t) {
    return typeof t == "string" ? new Jt([[document.querySelector(t)]],[document.documentElement]) : new Jt([[t]],Fa)
}
function yr(t, e, n) {
...
function Ve(t) {
    ...
    (e = Eu.exec(t)) ? (n = e[1].length,
    e = parseInt(e[1], 16),
    n === 6 ? So(e) : n === 3 ? new qt(e >> 8 & 15 | e >> 4 & 240,e >> 4 & 15 | e & 240,(e & 15) << 4 | e & 15,1) : n === 8 ? Bn(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? Bn(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = Au.exec(t)) ? new qt(e[1],e[2],e[3],1) : (e = Uu.exec(t)) ? new qt(e[1] * 255 / 100,e[2] * 255 / 100,e[3] * 255 / 100,1) : (e = Fu.exec(t)) ? Bn(e[1], e[2], e[3], e[4]) : (e = zu.exec(t)) ? Bn(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = Iu.exec(t)) ? Co(e[1], e[2] / 100, e[3] / 100, 1) : (e = Lu.exec(t)) ? Co(e[1], e[2] / 100, e[3] / 100, e[4]) : Mo.hasOwnProperty(t) ? So(Mo[t]) : t === "transparent" ? new qt(NaN,NaN,NaN,0) : null
}
function So(t) {
...
function za(t) {
    return t instanceof _n || (t = Ve(t)),
    t ? (t = t.rgb(),
    new qt(t.r,t.g,t.b,t.opacity)) : new qt
}
function ci(t, e, n, r) {
...
yr(qt, ci, xi(_n, {
    brighter(t) {
        return t = t == null ? pn : Math.pow(pn, t),
        new qt(this.r * t,this.g * t,this.b * t,this.opacity)
    },
    darker(t) {
        return t = t == null ? Re : Math.pow(Re, t),
        new qt(this.r * t,this.g * t,this.b * t,this.opacity)
    },
    rgb() {
        return this
...
function Ia(t) {
    ...
    var e = t.r / 255
      ...
      , s = o - i
      , u = (o + i) / 2;
    return s ? (e === o ? a = (n - r) / s + (n < r) * 6 : n === o ? a = (r - e) / s + 2 : a = (e - n) / s + 4,
    s /= u < .5 ? o + i : 2 - o - i,
    a *= 60) : s = u > 0 && u < 1 ? 0 : a,
...
yr(le, Yu, xi(_n, {
    ...
    rgb() {
        var t = this.h % 360 + (this.h < 0) * 360
          ...
          , r = n + (n < .5 ? n : 1 - n) * e
          , i = 2 * n - r;
        return new qt(Vr(t >= 240 ? t - 240 : t + 120, i, r),Vr(t, i, r),Vr(t < 120 ? t + 240 : t - 120, i, r),this.opacity)
    },
    clamp() {
    ...
    formatHsl() {
        const t = or(this.opacity);
        return `${t === 1 ? "hsl(" : "hsla("}${Eo(this.h)}, ${Xn(this.s) * 100}%, ${Xn(this.l) * 100}%${t === 1 ? ")" : `, ${t})`}`
    }
}));
function Eo(t) {
    return t = (t || 0) % 360,
...
function Wu(t) {
    if (t instanceof He)
        return new He(t.h,t.s,t.l,t.opacity);
...
yr(He, ze, xi(_n, {
    ...
    rgb() {
        var t = isNaN(this.h) ? 0 : (this.h + 120) * Ou
          ...
          , r = Math.cos(t)
          , i = Math.sin(t);
        return new qt(255 * (e + n * (La * r + ki * i)),255 * (e + n * (Mi * r + _r * i)),255 * (e + n * (An * r)),this.opacity)
    }
}));
var wr = t => () => t;
function Ha(t, e) {
...
function Bu(t, e) {
    var n = e - t;
    return n ? Ha(t, n > 180 || n < -180 ? n - 360 * Math.round(n / 360) : n) : wr(isNaN(t) ? e : t)
}
function Xu(t) {
    return (t = +t) == 1 ? fn : function(e, n) {
...
function Ra(t, e) {
    var n = fi.lastIndex = Yr.lastIndex = 0, r, i, o, a = -1, s = [], u = [];
    for (t = t + "",
    e = e + ""; (r = fi.exec(t)) && (i = Yr.exec(e)); )
    ...
    s[a] ? s[a] += o : s[++a] = o),
    s.length < 2 ? u[0] ? tc(u[0].x) : $u(e) : (e = u.length,
    function(l) {
        for (var f = 0, h; f < e; ++f)
            s[(h = u[f]).i] = h.x(l);
        return s.join("")
...
function br(t, e) {
    var n = typeof e, r;
    return e == null || n === "boolean" ? wr(e) : (n === "number" ? se : n === "string" ? (r = Ve(e)) ? (e = r,
    ar) : Ra : e instanceof Ve ? ar : e instanceof Date ? Ku : Qu(e) ? Zu : Array.isArray(e) ? Ju : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? ju : se)(t, e)
}
function Va(t, e) {
    return t = +t,
    e = +e,
...
function nc(t) {
    return t == null || (Zn || (Zn = document.createElementNS("http://www.w3.org/2000/svg", "g")),
    Zn.setAttribute("transform", t),
    !(t = Zn.transform.baseVal.consolidate())) ? hi : (t = t.matrix,
    Ya(t.a, t.b, t.c, t.d, t.e, t.f))
}
function Oa(t, e, n, r) {
    function i(l) {
    ...
    function o(l, f, h, p, d, k) {
        if (l !== h || f !== p) {
            ...
            (h || p) && d.push("translate(" + h + e + p + n)
    }
    function a(l, f, h, p) {
        l !== f ? (l - f > 180 ? f += 360 : f - l > 180 && (l += 360),
        p.push({
...
qa(Bu);
var Wa = qa(fn), dn = 0, Sn = 0, bn = 0, Ga = 1e3, sr, Pn, lr = 0, Ye = 0, xr = 0, Un = typeof performance == "object" && performance.now ? performance : Date, Ba = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
    setTimeout(t, 17)
}
;
function Ti() {
...
ur.prototype = Xa.prototype = {
    ...
    restart: function(t, e, n) {
        ...
        !this._next && Pn !== this && (Pn ? Pn._next = this : sr = this,
        Pn = this),
        this._call = t,
        this._time = n,
        pi()
...
function ac() {
    ...
    ++dn;
    for (var t = sr, e; t; )
        (e = Ye - t._time) >= 0 && t._call.call(void 0, e),
        t = t._next;
    --dn
}
function Io() {
...
function pi(t) {
    if (!dn) {
        ...
        var e = t - Ye;
        e > 24 ? (t < 1 / 0 && (Sn = setTimeout(Io, t - Un.now() - xr)),
        bn && (bn = clearInterval(bn))) : (bn || (lr = Un.now(),
        bn = setInterval(sc, Ga)),
        dn = 1,
        Ba(Io))
    }
}
...
function fc(t, e, n) {
    ...
    function a(l) {
        ...
        n.state === di) {
            for (n.state = tr,
            i = new Array(p = n.tween.length),
            f = 0,
            h = -1; f < p; ++f)
                (d = n.tween[f].value.call(t, t.__data__, n.index, n.group)) && (i[++h] = d);
            i.length = h + 1
        }
    }
    function s(l) {
        for (var f = l < n.duration ? n.ease.call(null, l / n.duration) : (n.timer.restart(u),
        n.state = gi,
        1), h = -1, p = i.length; ++h < p; )
            i[h].call(t, f);
        n.state === gi && (n.on.call("end", t, t.__data__, n.index, n.group),
        u())
    }
    function u() {
        n.state = er,
...
function Qa(t, e) {
    var n;
    return (typeof e == "number" ? se : e instanceof Ve ? ar : (n = Ve(e)) ? (e = n,
    ar) : Ra)(t, e)
}
function vc(t) {
    return function() {
...
function bc(t, e, n) {
    ...
    return function() {
        var a, s = n(this), u;
        return s == null ? void this.removeAttribute(t) : (a = this.getAttribute(t),
        u = s + "",
...
function xc(t, e, n) {
    ...
    return function() {
        var a, s = n(this), u;
        return s == null ? void this.removeAttributeNS(t.space, t.local) : (a = this.getAttributeNS(t.space, t.local),
        u = s + "",
        a === u ? null : a === r && u === i ? o : (i = u,
        o = e(r = a, s)))
    }
...
function kc(t, e) {
    var n = vr(t)
      , r = n === "transform" ? ic : Qa;
    return this.attrTween(t, typeof e == "function" ? (n.local ? xc : bc)(n, r, Si(this, "attr." + t, e)) : e == null ? (n.local ? yc : vc)(n) : (n.local ? wc : _c)(n, r, e))
}
function Mc(t, e) {
    return function(n) {
...
function Ec(t) {
    var e = this._id;
    return arguments.length ? this.each((typeof t == "function" ? Nc : Cc)(e, t)) : ue(this.node(), e).delay
}
function Ac(t, e) {
    return function() {
...
function Fc(t) {
    var e = this._id;
    return arguments.length ? this.each((typeof t == "function" ? Ac : Uc)(e, t)) : ue(this.node(), e).duration
}
function zc(t, e) {
    if (typeof e != "function")
        throw new Error;
...
function Vc(t) {
    ...
    for (var e = this._groups, n = t._groups, r = e.length, i = n.length, o = Math.min(r, i), a = new Array(r), s = 0; s < o; ++s)
        for (var u = e[s], l = n[s], f = u.length, h = a[s] = new Array(f), p, d = 0; d < f; ++d)
            (p = u[d] || l[d]) && (h[d] = p);
    for (; s < r; ++s)
        a[s] = e[s];
...
function qc(t, e) {
    var n = this._id;
    return arguments.length < 2 ? ue(this.node(), n).on.on(t) : this.each(Oc(n, t, e))
}
function Wc(t) {
    return function() {
...
function Bc(t) {
    ...
    for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
        for (var s = r[a], u = s.length, l = o[a] = new Array(u), f, h, p = 0; p < u; ++p)
            (f = s[p]) && (h = t.call(f, f.__data__, p, s)) && ("__data__"in f && (h.__data__ = f.__data__),
            l[p] = h,
...
function Xc(t) {
    ...
    for (var r = this._groups, i = r.length, o = [], a = [], s = 0; s < i; ++s)
        for (var u = r[s], l = u.length, f, h = 0; h < l; ++h)
            if (f = u[h]) {
                for (var p = t.call(f, f.__data__, h, u), d, k = ue(f, n), S = 0, F = p.length; S < F; ++S)
...
function jc(t, e, n) {
    ...
    return function() {
        var a = hn(this, t)
          , s = n(this)
          , u = s + "";
        return s == null && (u = s = (this.style.removeProperty(t),
        hn(this, t))),
        a === u ? null : a === r && u === i ? o : (i = u,
        o = e(r = a, s))
    }
...
function $c(t, e) {
    ...
    return function() {
        ...
        (l !== n || i !== f) && (r = (n = l).copy()).on(a, i = f),
        u.on = r
    }
}
function tf(t, e, n) {
    var r = (t += "") == "transform" ? rc : Qa;
    return e == null ? this.styleTween(t, Jc(t, r)).on("end.style." + t, Ja(t)) : typeof e == "function" ? this.styleTween(t, jc(t, r, Si(this, "style." + t, e))).each($c(this._id, t)) : this.styleTween(t, Kc(t, r, e), n).on("end.style." + t, null)
}
function ef(t, e, n) {
    return function(r) {
...
function sf(t) {
    return this.tween("text", typeof t == "function" ? af(Si(this, "text", t)) : of(t == null ? "" : t + ""))
}
function lf(t) {
    return function(e) {
...
function ff() {
    for (var t = this._name, e = this._id, n = Ka(), r = this._groups, i = r.length, o = 0; o < i; ++o)
...
function wf(t) {
    ...
    return isNaN(t) ? "Invalid Date" : _f(t.getUTCFullYear()) + "-" + Xt(t.getUTCMonth() + 1, 2) + "-" + Xt(t.getUTCDate(), 2) + (i ? "T" + Xt(e, 2) + ":" + Xt(n, 2) + ":" + Xt(r, 2) + "." + Xt(i, 3) + "Z" : r ? "T" + Xt(e, 2) + ":" + Xt(n, 2) + ":" + Xt(r, 2) + "Z" : n || e ? "T" + Xt(e, 2) + ":" + Xt(n, 2) + "Z" : "")
}
function methodthatgetsthefunctionwewant(t) {
    var regexpression = new RegExp('["' + t + `
\r]`)
      , n = t.charCodeAt(0);
    function r(h, p) {
        var d, k, S = i(h, function(F, z) {
            if (d)
                return d(F, z - 1);
            k = F,
            d = p ? yf(F, p) : ja(F)
    ...
    function i(h, p) {
        var d = [], k = h.length, S = 0, F = 0, z, B = k <= 0, O = !1;
        h.charCodeAt(k - 1) === xn && --k,
        h.charCodeAt(k - 1) === Wr && --k;
        function W() {
            if (B)
                return Or;
            if (O)
            ...
            if (h.charCodeAt(Y) === qr) {
                for (; S++ < k && h.charCodeAt(S) !== qr || h.charCodeAt(++S) === qr; )
                    ;
                return (M = S) >= k ? B = !0 : (nt = h.charCodeAt(S++)) === xn ? O = !0 : nt === Wr && (O = !0,
                h.charCodeAt(S) === xn && ++S),
                h.slice(Y + 1, M - 1).replace(/""/g, '"')
            }
            for (; S < k; ) {
                if ((nt = h.charCodeAt(M = S++)) === xn)
                    O = !0;
                else if (nt === Wr)
                    O = !0,
                    h.charCodeAt(S) === xn && ++S;
...
`)
    ...
    function f(idek) {
        return idek == null ? "" : idek instanceof Date ? wf(idek) : regexpression.test(idek += "") ? '"' + idek.replace(/"/g, '""') + '"' : idek
    }
    return {
        parse: r,
        parseRows: i,
...
var xf = methodthatgetsthefunctionwewant(",")
  , mysteryfunction = xf.parseRows;
function Mf(t) {
...
var Go = Array.prototype.map
  , Bo = ["y", "z", "a", "f", "p", "n", "\xB5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function Cf(t) {
    var e = t.grouping === void 0 || t.thousands === void 0 ? Wo : Tf(Go.call(t.grouping, Number), t.thousands + "")
    ...
    function l(h) {
        ...
        var p = h.fill
          ...
          , H = h.type;
        H === "n" ? (B = !0,
        H = "g") : qo[H] || (O === void 0 && (O = 12),
        W = !0,
        H = "g"),
        (F || p === "0" && d === "=") && (F = !0,
        p = "0",
        d = "=");
        var M = S === "$" ? n : S === "#" && /[boxX]/.test(H) ? "0" + H.toLowerCase() : ""
          , Y = S === "$" ? r : /[%p]/.test(H) ? a : ""
          , nt = qo[H]
          , Q = /[defgprs%]/.test(H);
        O = O === void 0 ? 6 : /[gprs]/.test(H) ? Math.max(1, Math.min(21, O)) : Math.max(0, Math.min(20, O));
        function Z(D) {
            var J = M, et = Y, ht, wt, St;
            if (H === "c")
                et = nt(D) + et,
                D = "";
            else {
                D = +D;
                var ot = D < 0 || 1 / D < 0;
                if (D = isNaN(D) ? u : nt(Math.abs(D), O),
                W && (D = Pf(D)),
                ot && +D == 0 && k !== "+" && (ot = !1),
                J = (ot ? k === "(" ? k : s : k === "-" || k === "(" ? "" : k) + J,
                et = (H === "s" ? Bo[8 + $a / 3] : "") + et + (ot && k === "(" ? ")" : ""),
                Q) {
                    for (ht = -1,
                    wt = D.length; ++ht < wt; )
                        if (St = D.charCodeAt(ht),
                        48 > St || St > 57) {
            ...
            switch (B && F && (D = e(ct + D, ct.length ? z - et.length : 1 / 0),
            ct = ""),
            d) {
            case "<":
                D = J + D + et + ct;
...
function Uf(t, e) {
    return Math.max(0, Math.max(-8, Math.min(8, Math.floor(gn(e) / 3))) * 3 - gn(Math.abs(t)))
}
function Ff(t, e) {
    return t = Math.abs(t),
    e = Math.abs(e) - t,
    Math.max(0, gn(e) - gn(t)) + 1
}
function In(t, e) {
...
function Ci() {
    var t = Zo, e = Zo, n = br, r, i, o, a = ie, s, u, l;
    function f() {
        var p = Math.min(t.length, e.length);
        return a !== ie && (a = Lf(t[0], t[p - 1])),
        s = p > 2 ? Rf : Hf,
        u = l = null,
        h
    }
    function h(p) {
        return p == null || isNaN(p = +p) ? o : (u || (u = s(t.map(r), e, n)))(r(a(p)))
    }
    ...
    ,
    h.domain = function(p) {
        return arguments.length ? (t = Array.from(p, If),
        f()) : t.slice()
    }
    ,
    h.range = function(p) {
        return arguments.length ? (e = Array.from(p),
        f()) : e.slice()
    }
    ,
    h.rangeRound = function(p) {
        return e = Array.from(p),
        n = Va,
        f()
    }
    ,
    h.clamp = function(p) {
        return arguments.length ? (a = p ? !0 : ie,
        f()) : a !== ie
    }
    ,
...
function Vf(t, e, n, r) {
    var i = si(t, e, n), o;
    switch (r = Fn(r == null ? ",f" : r),
    r.type) {
    case "s":
        {
            var a = Math.max(Math.abs(t), Math.abs(e));
            return r.precision == null && !isNaN(o = Uf(i, a)) && (r.precision = o),
            ts(r, a)
        }
    case "":
    case "e":
    ...
    case "r":
        {
            r.precision == null && !isNaN(o = Ff(i, Math.max(Math.abs(t), Math.abs(e)))) && (r.precision = o - (r.type === "e"));
            break
        }
    case "f":
    case "%":
        {
            r.precision == null && !isNaN(o = Af(i)) && (r.precision = o - (r.type === "%") * 2);
            break
        }
    }
    return Ni(r)
...
function Ei(t) {
    ...
    t.nice = function(n) {
        n == null && (n = 10);
        var r = e(), i = 0, o = r.length - 1, a = r[i], s = r[o], u, l, f = 10;
        for (s < a && (l = a,
        a = s,
        s = l,
        l = i,
...
function Gf(t) {
    return t === Math.E ? Math.log : t === 10 && Math.log10 || t === 2 && Math.log2 || (t = Math.log(t),
    e => Math.log(e) / t)
}
function Ko(t) {
    return (e, n) => -t(-e, n)
...
function is(t) {
    ...
    e.tickFormat = (s, u) => {
        if (s == null && (s = 10),
        u == null && (u = r === 10 ? "s" : ","),
        typeof u != "function" && (!(r % 1) && (u = Fn(u)).precision == null && (u.trim = !0),
        u = Ni(u)),
        s === 1 / 0)
            return u;
...
function de() {
    ...
    return t.copy = () => Mr(t, de()).base(t.base()),
    In.apply(t, arguments),
    t
}
function jo(t) {
...
function Zf(t) {
    var e = t(ie, ie)
      , n = 1;
    function r() {
        return n === 1 ? t(ie, ie) : n === .5 ? t(Bf, Xf) : t(jo(n), jo(1 / n))
    }
...
function Vt(t, e, n, r) {
    function i(o) {
        return t(o = arguments.length === 0 ? new Date : new Date(+o)),
        o
    }
    return i.floor = function(o) {
        return t(o = new Date(+o)),
        o
    }
    ,
    i.ceil = function(o) {
        return t(o = new Date(o - 1)),
        e(o, 1),
        t(o),
        o
    }
    ...
    i.offset = function(o, a) {
        return e(o = new Date(+o), a == null ? 1 : Math.floor(a)),
        o
    }
    ,
    ...
    i.every = function(o) {
        ...
        !isFinite(o) || !(o > 0) ? null : o > 1 ? i.filter(r ? function(a) {
            return r(a) % o === 0
        }
        : function(a) {
...
var fr = Vt(function() {}, function(t, e) {
    t.setTime(+t + e)
}, function(t, e) {
    return e - t
});
fr.every = function(t) {
    ...
    !isFinite(t) || !(t > 0) ? null : t > 1 ? Vt(function(e) {
...
var ss = Vt(function(t) {
  ...
  , ls = ss;
ss.range;
var us = Vt(function(t) {
    t.setTime(t - t.getMilliseconds() - t.getSeconds() * Te - t.getMinutes() * oe)
}, function(t, e) {
    t.setTime(+t + e * De)
}, function(t, e) {
    return (e - t) / De
  ...
  , cs = us;
us.range;
var fs = Vt(t => t.setHours(0, 0, 0, 0), (t, e) => t.setDate(t.getDate() + e), (t, e) => (e - t - (e.getTimezoneOffset() - t.getTimezoneOffset()) * oe) / Oe, t => t.getDate() - 1)
  , Tr = fs;
fs.range;
function We(t) {
    return Vt(function(e) {
        ...
        return (n - e - (n.getTimezoneOffset() - e.getTimezoneOffset()) * oe) / Ai
    })
}
var Dr = We(0)
  , hr = We(1)
...
Ui.every = function(t) {
    return !isFinite(t = Math.floor(t)) || !(t > 0) ? null : Vt(function(e) {
...
function ys(t, e, n, r, i, o) {
    const a = [[Cn, 1, Te], [Cn, 5, 5 * Te], [Cn, 15, 15 * Te], [Cn, 30, 30 * Te], [o, 1, oe], [o, 5, 5 * oe], [o, 15, 15 * oe], [o, 30, 30 * oe], [i, 1, De], [i, 3, 3 * De], [i, 6, 6 * De], [i, 12, 12 * De], [r, 1, Oe], [r, 2, 2 * Oe], [n, 1, Ai], [e, 1, $o], [e, 3, 3 * $o], [t, 1, Xr]];
    function s(l, f, h) {
        const p = f < l;
        p && ([l,f] = [f, l]);
    ...
    function u(l, f, h) {
        const p = Math.abs(f - l) / h
          , d = _i( ([,,F]) => F).right(a, p);
        if (d === a.length)
            return t.every(si(l / Xr, f / Xr, h));
        if (d === 0)
            return Qf.every(Math.max(si(l, f, h), 1));
...
function uh(t) {
    ...
    function M(T, N) {
        return function(X) {
            var b = [], lt = -1, K = 0, rt = T.length, v, it, I;
            for (X instanceof Date || (X = new Date(+X)); ++lt < rt; )
                T.charCodeAt(lt) === 37 && (b.push(T.slice(K, lt)),
                (it = ta[v = T.charAt(++lt)]) != null ? v = T.charAt(++lt) : it = v === "e" ? " " : "0",
                (I = N[v]) && (v = I(X, it)),
                b.push(v),
                K = lt + 1);
            return b.push(T.slice(K, lt)),
            b.join("")
        }
    }
    function Y(T, N) {
        return function(X) {
            var b = kn(1900, void 0, 1), lt = nt(b, T, X += "", 0), K, rt;
            if (lt != X.length)
                return null;
            if ("Q"in b)
                return new Date(b.Q);
            ...
            "V"in b) {
                ...
                ("W"in b || "U"in b) && ("w"in b || (b.w = "u"in b ? b.u % 7 : "W"in b ? 1 : 0),
                rt = "Z"in b ? Qr(kn(b.y, 0, 1)).getUTCDay() : Zr(kn(b.y, 0, 1)).getDay(),
                b.m = 0,
                b.d = "W"in b ? (b.w + 6) % 7 + b.W * 7 - (rt + 5) % 7 : b.w + b.U * 7 - (rt + 6) % 7);
            return "Z"in b ? (b.H += b.Z / 100 | 0,
            b.M += b.Z % 100,
            Qr(b)) : Zr(b)
        }
    }
    function nt(T, N, X, b) {
        for (var lt = 0, K = N.length, rt = X.length, v, it; lt < K; ) {
            if (b >= rt)
                return -1;
            if (v = N.charCodeAt(lt++),
            v === 37) {
                if (v = N.charAt(lt++),
                it = H[v in ta ? N.charAt(lt++) : v],
                !it || (b = it(T, X, b)) < 0)
                    return -1
            } else if (v != X.charCodeAt(b++))
                return -1
        }
        return b
    }
    function Q(T, N, X) {
        ...
        return b ? (T.p = f.get(b[0].toLowerCase()),
        X + b[0].length) : -1
    }
    function Z(T, N, X) {
        var b = d.exec(N.slice(X));
        return b ? (T.w = k.get(b[0].toLowerCase()),
        X + b[0].length) : -1
    }
    function D(T, N, X) {
        var b = h.exec(N.slice(X));
        return b ? (T.w = p.get(b[0].toLowerCase()),
        X + b[0].length) : -1
    }
    function J(T, N, X) {
        var b = z.exec(N.slice(X));
        return b ? (T.m = B.get(b[0].toLowerCase()),
        X + b[0].length) : -1
    }
    function et(T, N, X) {
        var b = S.exec(N.slice(X));
        return b ? (T.m = F.get(b[0].toLowerCase()),
        X + b[0].length) : -1
    }
    function ht(T, N, X) {
        return nt(T, e, N, X)
...
function Hh(t, e) {
    return t = ws(t),
    mt(mn.count(qe(t), t) + (qe(t).getDay() === 4), e, 2)
}
function Rh(t) {
    return t.getDay()
}
...
function Wh(t, e) {
    var n = t.getDay();
    return t = n >= 4 || n === 0 ? mn(t) : mn.ceil(t),
    mt(t.getFullYear() % 1e4, e, 4)
}
function Gh(t) {
    var e = t.getTimezoneOffset();
    return (e > 0 ? "-" : (e *= -1,
    "+")) + mt(e / 60 | 0, "0", 2) + mt(e % 60, "0", 2)
}
function aa(t, e) {
...
function e0(t, e) {
    return t = xs(t),
    mt(vn.count(yn(t), t) + (yn(t).getUTCDay() === 4), e, 2)
}
function n0(t) {
    return t.getUTCDay()
}
...
function s0(t, e) {
    var n = t.getUTCDay();
    return t = n >= 4 || n === 0 ? vn(t) : vn.ceil(t),
...
function Ms(t, e, n, r, i, o, a, s, u, l) {
    var f = ns()
      ...
      , W = l("%Y");
    function H(M) {
        return (u(M) < M ? d : s(M) < M ? k : a(M) < M ? S : o(M) < M ? F : r(M) < M ? i(M) < M ? z : B : n(M) < M ? O : W)(M)
    }
    ...
    f.nice = function(M) {
        var Y = p();
        return (!M || typeof M.range != "function") && (M = e(Y[0], Y[Y.length - 1], M == null ? 10 : M)),
        M ? p(rs(Y, M)) : f
    }
    ,
    f.copy = function() {
...
function h0() {
    return In.apply(Ms(sh, lh, qe, ps, Dr, Tr, cs, ls, Cn, ks).domain([new Date(2e3,0,1), new Date(2e3,0,2)]), arguments)
}
function Ts() {
    var t = 0, e = 1, n, r, i, o, a = ie, s = !1, u;
    function l(h) {
        return h == null || isNaN(h = +h) ? u : a(i === 0 ? .5 : (h = (o(h) - n) * i,
        s ? Math.max(0, Math.min(1, h)) : h))
    }
    l.domain = function(h) {
        return arguments.length ? ([t,e] = h,
        n = o(t = +t),
        r = o(e = +e),
        i = n === r ? 0 : 1 / (r - n),
        l) : [t, e]
...
var Jr = p0("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf")
  , Kn = Wa(ze(-100, .75, .35), ze(80, 1.5, .8));
Wa(ze(260, .75, .35), ze(80, 1.5, .8));
ze();
function un(t, e, n) {
    this.k = t,
    this.x = e,
...
un.prototype;
function d0(t) {
    let e, n, r, i, o, a = t[0].name + "", s, u, l, f, h, p, d, k = t[0].releaseDate + "", S, F, z, B, O, W, H, M = t[0].freq + "", Y, nt, Q, Z, D, J, et, ht, wt = t[0].transistors + "", St, ot, ut, ct, Dt, st, Ct, Pt, zt = t[0].dieSize + "", xt, vt, bt, Ht, T, N, X, b, lt, K, rt = t[0].tdp + "", v, it, I;
    return {
        c() {
            e = _("div"),
            n = _("div"),
        ...
        h() {
            ...
            m(e, "class", I = "tooltip " + (t[1] ? "show" : "hide") + " svelte-1b8uvt"),
            qn(e, "left", t[2] + 2 + "px"),
            qn(e, "top", t[3] + 2 + "px")
        },
        m(U, L) {
        ...
        p(U, [L]) {
            ...
            L & 2 && I !== (I = "tooltip " + (U[1] ? "show" : "hide") + " svelte-1b8uvt") && m(e, "class", I),
...
function da(t) {
    ...
    return {
        ...
        h() {
            m(e, "class", i = "btn " + (t[2] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")
        },
        m(u, l) {
            Ft(u, e, l),
            c(e, r),
        ...
        p(u, l) {
            t = u,
            l[0] & 4 && i !== (i = "btn " + (t[2] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp") && m(e, "class", i)
        },
        d(u) {
            u && g(e),
            o = !1,
...
function ga(t) {
    ...
    return {
        ...
        h() {
            m(e, "class", i = "btn " + (t[3] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")
        },
        m(u, l) {
            Ft(u, e, l),
            c(e, r),
        ...
        p(u, l) {
            t = u,
            l[0] & 8 && i !== (i = "btn " + (t[3] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp") && m(e, "class", i)
        },
        d(u) {
            u && g(e),
            o = !1,
...
function ma(t) {
    ...
    return {
        ...
        h() {
            m(e, "class", i = "btn " + (t[4] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")
        },
        m(u, l) {
            Ft(u, e, l),
            c(e, r),
        ...
        p(u, l) {
            t = u,
            l[0] & 16 && i !== (i = "btn " + (t[4] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp") && m(e, "class", i)
        },
        d(u) {
            u && g(e),
            o = !1,
...
function va(t) {
    ...
    return {
        ...
        h() {
            m(e, "class", i = "btn " + (t[5] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")
        },
        m(u, l) {
            Ft(u, e, l),
            c(e, r),
        ...
        p(u, l) {
            t = u,
            l[0] & 32 && i !== (i = "btn " + (t[5] === t[49] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp") && m(e, "class", i)
        },
        d(u) {
            u && g(e),
            o = !1,
...
function v0(t) {
    let e, n, r, i, o, a, s, u, l, f, h, p, d, k, S, F, z, B, O, W, H, M, Y, nt, Q, Z, D, J, et, ht, wt, St, ot, ut, ct, Dt, st, Ct, Pt, zt, xt, vt, bt, Ht, T, N, X, b, lt, K, rt, v, it, I, U, L, A, q, $, tt, P, dt, kt, Tt = t[20], ft = [];
    for (let x = 0; x < Tt.length; x += 1)
        ft[x] = da(pa(t, Tt, x));
    let j = t[21]
      , pt = [];
    ...
    let Et = t[22]
      , Mt = [];
    for (let x = 0; x < Et.length; x += 1)
        Mt[x] = ma(fa(t, Et, x));
    let Wt = t[23]
      , At = [];
    for (let x = 0; x < Wt.length; x += 1)
        At[x] = va(ca(t, Wt, x));
    X = new m0({
        props: {
            product: t[19],
    ...
    return {
        ...
        l(x) {
            ...
            Be.forEach(g),
            B = V(Pe);
            for (let Lt = 0; Lt < ft.length; Lt += 1)
                ft[Lt].l(Pe);
            Pe.forEach(g),
            ye.forEach(g),
            O = V(x),
            ...
            Xe.forEach(g),
            nt = V(ae);
            for (let Lt = 0; Lt < pt.length; Lt += 1)
                pt[Lt].l(ae);
            ae.forEach(g),
            Zt.forEach(g),
            Q = V(x),
            ...
            _e.forEach(g),
            ut = V(Ot);
            for (let Lt = 0; Lt < Mt.length; Lt += 1)
                Mt[Lt].l(Ot);
            Ot.forEach(g),
            Ze.forEach(g),
            ct = V(x),
        ...
        h() {
            ...
            m(a, "class", u = "btn " + (t[0] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp"),
            m(f, "class", p = "btn " + (t[1] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp"),
            m(n, "class", "btn-group"),
            ...
            m(wt, "class", ot = "btn " + (t[4] === "None" ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp"),
            m(D, "class", "btn-group"),
            m(Z, "class", "btn-row svelte-pesovp"),
            m(Ct, "class", "input-group-text"),
            m(xt, "class", bt = "btn " + (t[5] === "None" ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp"),
        ...
        m(x, at) {
            ...
            c(F, z),
            c(S, B);
            for (let gt = 0; gt < ft.length; gt += 1)
                ft[gt].m(S, null);
            Ft(x, O, at),
            Ft(x, W, at),
            c(W, H),
            ...
            c(M, Y),
            c(H, nt);
            for (let gt = 0; gt < pt.length; gt += 1)
                pt[gt].m(H, null);
            Ft(x, Q, at),
            Ft(x, Z, at),
            c(Z, D),
            ...
            c(wt, St),
            c(D, ut);
            for (let gt = 0; gt < Mt.length; gt += 1)
                Mt[gt].m(D, null);
            Ft(x, ct, at),
            Ft(x, Dt, at),
            c(Dt, st),
            ...
            t[40](U),
            P = !0,
            dt || (kt = [Nt(a, "click", t[24]), Nt(f, "click", t[25]), Nt(wt, "click", t[28]), Nt(xt, "click", t[30]), Nt(v, "click", t[34])],
            dt = !0)
        },
        p(x, at) {
            if ((!P || at[0] & 1 && u !== (u = "btn " + (x[0] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")) && m(a, "class", u),
            (!P || at[0] & 2 && p !== (p = "btn " + (x[1] ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")) && m(f, "class", p),
            at[0] & 1048580) {
                Tt = x[20];
                let G;
                for (G = 0; G < Tt.length; G += 1) {
                    const Rt = pa(x, Tt, G);
                    ft[G] ? ft[G].p(Rt, at) : (ft[G] = da(Rt),
                    ft[G].c(),
                    ft[G].m(S, null))
                }
                for (; G < ft.length; G += 1)
            ...
            if ((!P || at[0] & 16 && ot !== (ot = "btn " + (x[4] === "None" ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")) && m(wt, "class", ot),
            at[0] & 4194320) {
                Et = x[22];
                let G;
                for (G = 0; G < Et.length; G += 1) {
                    const Rt = fa(x, Et, G);
                    Mt[G] ? Mt[G].p(Rt, at) : (Mt[G] = ma(Rt),
                    Mt[G].c(),
                    Mt[G].m(D, null))
                }
                for (; G < Mt.length; G += 1)
            ...
            if ((!P || at[0] & 32 && bt !== (bt = "btn " + (x[5] === "None" ? "btn-primary" : "btn-outline-primary") + " svelte-pesovp")) && m(xt, "class", bt),
            at[0] & 8388640) {
                Wt = x[23];
                let G;
                for (G = 0; G < Wt.length; G += 1) {
                    const Rt = ca(x, Wt, G);
                    At[G] ? At[G].p(Rt, at) : (At[G] = va(Rt),
                    At[G].c(),
                    At[G].m(st, null))
                }
                for (; G < At.length; G += 1)
            ...
            X.$set(gt),
            x[4] !== "None" ? yt ? yt.p(x, at) : (yt = ya(x),
            yt.c(),
            yt.m(N, lt)) : yt && (yt.d(1),
            yt = null),
            x[5] !== "None" ? Ut ? Ut.p(x, at) : (Ut = _a(x),
            Ut.c(),
            Ut.m(N, K)) : Ut && (Ut.d(1),
            Ut = null)
        },
...
function _0(t, e, n) {
    let r = [], i, o, a, s, u, l, f, h, p = 0, d = 0, k = !1, S = 0, F = 0, z = {};
    const B = new Map([["Release Date", "releaseDate"], ["TDP (W)", "tdp"], ["Die Size (mm^2)", "dieSize"], ["Transistors (million)", "transistors"], ["Freq (MHz)", "freq"], ["FP16 GFLOPS", "fp16Perf"], ["FP32 GFLOPS", "fp32Perf"], ["FP64 GFLOPS", "fp64Perf"], ["Process Size (nm)", "processSize"], ["Vendor", "vendor"], ["Foundry", "foundry"], ["Type", "type"], ["Product", "name"]]);
    let O = ["Release Date", "TDP (W)", "Die Size (mm^2)", "Transistors (million)", "Freq (MHz)"]
      , W = ["TDP (W)", "Die Size (mm^2)", "Transistors (million)", "Freq (MHz)", "FP16 GFLOPS", "FP32 GFLOPS", "FP64 GFLOPS"]
      , H = ["Type", "Vendor", "Foundry", "Process Size (nm)", "TDP (W)", "Die Size (mm^2)", "Transistors (million)", "Freq (MHz)"]
    ...
    async function et() {
        const it = await (await fetch("data.csv")).text()
          , datawealsowant = mysteryfunction(it)
          , U = datawealsowant[0]
          , datawewant = datawealsowant.slice(1).map(A => {
            const q = {
                name: "",
                vendor: "",
                type: "",
            ...
            return U.forEach( ($, tt) => {
                ...
                case "Release Date":
                    ...
                    isNaN(P.getTime()) ? q.releaseDate = null : q.releaseDate = P;
                    break;
                ...
                case "FP32 GFLOPS":
                    q.fp32Perf = +A[tt],
                    q.fp32Perf === 0 && (q.fp32Perf = NaN);
                    break;
                case "FP64 GFLOPS":
                    q.fp64Perf = +A[tt],
                    q.fp64Perf === 0 && (q.fp64Perf = NaN);
                    break;
                case "FP16 GFLOPS":
                    q.fp16Perf = +A[tt],
                    q.fp16Perf === 0 && (q.fp16Perf = NaN);
                    break;
                case "Freq (GHz)":
                    q.freq = +A[tt],
                    q.freq === 0 && (q.freq = NaN);
        ...
        return console.log(datawewant),
        datawewant
    }
    function ht() {
        const v = St(r)
          , [it,I,U,L] = wt(v)
          , A = xe(h).selectAll("circle").data(v, $ => `${$.index}`);
        A.enter().append("circle").attr("cx", $ => {
            let tt = $[B.get(Q)];
            return it(tt) + Bt
        }
        ).attr("cy", Qt - ee + ne).attr("r", 5).attr("fill", $ => U ? U($[D]) : "#4287f5").attr("opacity", .1).on("mouseover", ($, tt) => {
            n(19, z = tt),
            n(17, S = $.pageX),
            n(18, F = $.pageY),
            n(16, k = !0)
        ...
        ).merge(A).transition().duration(500).attr("cx", $ => {
            let tt = $[B.get(Q)];
            return it(tt) + Bt
        }
        ).attr("cy", $ => I($[B.get(Z)]) + ne).attr("r", $ => {
            if (J === "None")
                return 5;
            const tt = L($[B.get(J)]);
            return tt < 0 ? 0 : tt
        ...
        A.exit().transition().duration(500).attr("opacity", 0).attr("cy", ne).remove()
    }
    function wt(v) {
        let it, I, U, L;
        switch (Q) {
        case "Release Date":
            it = h0().domain([be(v, P => P.releaseDate), It(v, P => P.releaseDate)]).range([0, re - Bt - ln]);
            break;
        case "TDP (W)":
            it = de().domain([be(v, P => P.tdp), It(v, P => P.tdp)]).range([0, re - Bt - ln]);
            break;
        case "Die Size (mm^2)":
            it = de().domain([50, It(v, P => P.dieSize)]).range([0, re - Bt - ln]);
            break;
        case "Transistors (million)":
            it = de().domain([be(v, P => P.transistors), It(v, P => P.transistors)]).range([0, re - Bt - ln]);
            break;
        case "Freq (MHz)":
            it = vi().domain([0, It(v, P => P.freq)]).range([0, re - Bt - ln]);
            break;
        default:
        ...
        switch (Z) {
        case "TDP (W)":
            I = de().domain([be(v, P => P.tdp), It(v, P => P.tdp)]).range([Qt - ee - ne, 0]);
            break;
        case "Die Size (mm^2)":
            I = de().domain([50, It(v, P => P.dieSize)]).range([Qt - ee - ne, 0]);
            break;
        case "Transistors (million)":
            I = de().domain([be(v, P => P.transistors), It(v, P => P.transistors)]).range([Qt - ee - ne, 0]);
            break;
        case "Freq (MHz)":
            I = vi().domain([0, It(v, P => P.freq)]).range([Qt - ee - ne, 0]);
            break;
        case "FP16 GFLOPS":
            n(0, Y = !1),
            I = de().domain([be(v, P => P.fp16Perf), It(v, P => P.fp16Perf)]).range([Qt - ee - ne, 0]);
            break;
        case "FP32 GFLOPS":
            n(0, Y = !1),
            I = de().domain([be(v, P => P.fp32Perf), It(v, P => P.fp32Perf)]).range([Qt - ee - ne, 0]);
            break;
        case "FP64 GFLOPS":
            n(0, Y = !1),
            I = de().domain([be(v, P => P.fp64Perf), It(v, P => P.fp64Perf)]).range([Qt - ee - ne, 0]);
            break;
        default:
        ...
        case "Vendor":
            let kt = ["Intel", "AMD", "ATI", "NVIDIA", "Other"]
              , Tt = ["rgb(2, 109, 191)", "rgb(216, 0, 49)", "rgb(253, 2, 1)", "rgb(118, 185, 0)", "rgb(128, 128, 128)"];
            U = Nn().domain(kt).range(Tt),
            ot(kt, U, !1, !0);
            break;
        case "Type":
            let ft = ["CPU", "GPU"];
            U = Nn().domain(ft).range(Jr),
            ot(ft, U);
            break
        }
        const q = 15;
        ...
        return xe(o).call($).attr("transform", `translate(
					${Bt}, 
					${Qt - ee}
				)`).call(P => P.selectAll("text").attr("font-size", "14")).call(P => P.selectAll(".tick line").attr("stroke-opacity", .1).attr("stroke-dasharray", "2,2")),
        xe(s).attr("x", re / 2).attr("y", Qt - ee / 2).text(Q),
        xe(a).call(tt).attr("transform", `translate(${Bt}, ${ne})`).call(P => P.selectAll("text").attr("font-size", "14")).call(P => P.selectAll(".tick line").attr("stroke-opacity", .1).attr("stroke-dasharray", "2,2")),
        xe(u).attr("transform", `translate(40, ${(Qt - ee) / 2}) rotate(-90)`).attr("text-anchor", "middle").text(Z),
        [it, I, U, L]
    }
    function St(v) {
        return v.filter(I => !(!Y && I.type === "CPU" || !nt && I.type === "GPU" || Q === "Release Date" && I.releaseDate === null || (Q === "Freq (MHz)" || Z === "Freq (MHz)" || D === "Freq (MHz)" || J === "Freq (MHz)") && (I.freq === null || I.freq === 0 || isNaN(I.freq)) || (Q === "Transistors (million)" || Z === "Transistors (million)" || D === "Transistors (million)" || J === "Transistors (million)") && (I.transistors === null || I.transistors === 0 || isNaN(I.transistors)) || (Q === "TDP (W)" || Z === "TDP (W)" || D === "TDP (W)" || J === "TDP (W)") && (I.tdp === null || I.tdp === 0 || isNaN(I.tdp)) || (Q === "Die Size (mm^2)" || Z === "Die Size (mm^2)" || D === "Die Size (mm^2)" || J === "Die Size (mm^2)") && (I.dieSize === null || I.dieSize === 0 || isNaN(I.dieSize)) || (Q === "Process Size (nm)" || Z === "Process Size (nm)" || D === "Process Size (nm)" || J === "Process Size (nm)") && (I.processSize === null || I.processSize === "") || Z === "FP16 GFLOPS" && (I.fp16Perf === null || I.fp16Perf === 0 || isNaN(I.fp16Perf)) || Z === "FP32 GFLOPS" && (I.fp32Perf === null || I.fp32Perf === 0 || isNaN(I.fp32Perf)) || Z === "FP64 GFLOPS" && (I.fp64Perf === null || I.fp64Perf === 0 || isNaN(I.fp64Perf))))
    }
    function ot(v, it, I=!1, U=!1) {
        ...
        n(14, p = P * q + 5),
        xe(l).selectAll("*").remove();
        const dt = xe(l).selectAll("g").data(L).enter().append("g").attr("text-anchor", "middle").attr("transform", (kt, Tt) => {
        ...
        dt.append("circle").attr("r", 10).attr("cy", 0).attr("cx", 0).attr("fill", kt => it(kt)),
        dt.append("text").attr("x", 0).attr("y", 28).text(kt => typeof kt == "string" || kt instanceof String ? kt : kt === null ? 0 : kt.toFixed(0))
    }
    function ut(v, it, I=!1) {
        ...
        n(15, d = Tt * P + 5),
        xe(f).selectAll("*").remove();
        const ft = xe(f).selectAll("g").data(U).enter().append("g").attr("text-anchor", "middle").attr("transform", (j, pt) => {
        ...
        ft.append("circle").attr("r", j => it(j)).attr("cy", 0).attr("cx", 0).attr("fill", "#4287f5"),
        ft.append("text").attr("x", 0).attr("y", 28).text(j => typeof j == "string" || j instanceof String ? j : j === null ? 0 : j.toFixed(0))
    }
    const ct = () => {
        n(0, Y = !Y)
    }
    ...
    ,
    [Y, nt, Q, Z, D, J, i, o, a, s, u, l, f, h, p, d, k, S, F, z, O, W, H, M, ct, Dt, st, Ct, Pt, zt, xt, vt, bt, Ht, T, N, X, b, lt, K, rt]
}
class w0 extends dr {
    constructor(e) {
        super(),
...
function b0(t) {
    let e, n, r, i, o, a, s, u, l, f, h, p, d, k, S, F, z, B, O, W, H, M, Y, nt, Q, Z, D, J, et, ht, wt, St, ot, ut, ct, Dt, st, Ct, Pt, zt, xt;
    return {
        c() {
            e = _("div"),
            n = _("div"),
        ...
        m(vt, bt) {
            ...
            c(ot, st),
            c(st, Ct),
            zt || (xt = [Nt(u, "click", vo(t[8])), Nt(F, "input", t[9]), Nt(F, "input", t[5]), Nt(M, "input", t[10]), Nt(M, "input", t[5]), Nt(Q, "change", t[11]), Nt(Q, "input", t[12]), Nt(ut, "click", vo(t[7])), Nt(st, "click", t[13])],
            zt = !0)
        },
        p(vt, [bt]) {
...
function x0(t, e, n) {
    ...
    function u() {
        ...
        o.length > 0 && a.length > 0 && s ? (console.log("validated"),
        n(1, i = !0)) : n(1, i = !1)
    }
    async function l() {
        if (console.log("submitting..."),
        u(),
        !i)
            return;
        const B = await (await fetch("/download?" + new URLSearchParams({
            name: o,
            affiliation: a,
            agreed: String(s)
        }))).json();
...
function M0(t) {
    let e, n, r, i, o, a, s, u, l, f, h, p, d, k, S, F, z, B, O, W, H, M, Y, nt, Q, Z, D, J, et, ht, wt, St, ot, ut, ct, Dt, st, Ct, Pt, zt, xt, vt, bt, Ht, T, N, X, b, lt, K, rt, v, it, I, U, L, A, q, $, tt, P, dt, kt, Tt, ft, j, pt, Et, Mt, Wt, At, yt, Ut, x, at, gt, G, Rt, ve, ye, Pe, Be, Zt, ae, Xe, Ze, Ot, Qe, _e, Je, ce, we, Ke, Kt, Ne, fe, jt, Lt, Sr, he, je, Pr, Nr, Ce, Cr, $e, Er, Ar, Ur, tn, Fr, Ln, zr, Li;
    function Ps(_t) {
        t[7](_t)
    }
    let Hi = {};
    return t[6] !== void 0 && (Hi.show = t[6]),
    i = new k0({
        props: Hi
    }),
    ...
    }),
    {
		...
		smartlook('init', '6d9869e8e6de80f60330dc4c62724ab52a03aec2', {
            ...
            d = R(),
            k = _("p"),
            S = C(`We provide a dataset with 2231 CPUs and 2714 GPUs to help researchers
            ...
            xt = _("li"),
            vt = _("u"),
            bt = C(`High-end GPUs tends to first use new semiconductor technologies.
            ...
            Ur = R(),
            tn = _("p"),
            Fr = C(`Figures downloaded from this visualization tool follows a CC BY 4.0
				license.`),
            this.h()
        },
        l(_t) {
		...
		smartlook('init', '6d9869e8e6de80f60330dc4c62724ab52a03aec2', {
            ...
            var Ri = y(k);
            S = E(Ri, `We provide a dataset with 2231 CPUs and 2714 GPUs to help researchers
				understand the development trend of CPUs and GPUs. The dataset is last
				updated in Jan 2024.`),
            Ri.forEach(g),
            F = V(Ee),
            ...
            Ct = w(Qi, "U", {});
            var Ji = y(Ct);
            Pt = E(Ji, `GPU performance improvement is a joint effect of smaller
						transistors, larger die size, and higher frequency.`),
            Ji.forEach(g),
            Qi.forEach(g),
            zt = V(te),
            ...
            vt = w(Ki, "U", {});
            var ji = y(vt);
            bt = E(ji, `High-end GPUs tends to first use new semiconductor technologies.
						Low-end GPUs may use old technologies for a few years.`),
            ji.forEach(g),
            Ki.forEach(g),
            te.forEach(g),
            ...
            var go = y(tn);
            Fr = E(go, `Figures downloaded from this visualization tool follows a CC BY 4.0
				license.`),
            go.forEach(g),
            an.forEach(g),
            pe.forEach(g),
        ...
        m(_t, Gt) {
            ...
            c(tn, Fr),
            Ln = !0,
            zr || (Li = [Nt(H, "click", t[9]), Nt(Q, "click", t[10]), Nt(et, "click", t[11]), Nt(ot, "click", t[12]), Nt(st, "click", t[13]), Nt(xt, "click", t[14]), Nt(fe, "click", t[15])],
            zr = !0)
        },
        p(_t, [Gt]) {
            const wn = {};
